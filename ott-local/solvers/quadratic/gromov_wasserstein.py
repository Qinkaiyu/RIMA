...
class GromovWasserstein(was_solver.WassersteinSolver):
    ...
    def __init__(
        ...
        *args: Any,
        ...
        quad_initializer: Optional[
            Union[
                Literal["random", "rank2", "k-means", "generalized-k-means"],
        ...
        **kwargs: Any,
        ...
        super().__init__(kwargs=kwargs_sinkhorn, *args, **kwargs)
    ...
    def init_state(
        ...
        if self.store_inner_errors:
            errors = -jnp.ones(
                (num_iter, self.linear_ot_solver.outer_iterations)
            )
        else:
            errors = None
    ...
    def warm_start(self) -> bool:
        ...
        return (
            self.is_low_rank if self._warm_start is None else self._warm_start
        )
...
def iterations(
    ...
    def body_fn(
        ...
        if solver.is_low_rank:
            ...
            init = (
                (lin_state.q, lin_state.r, lin_state.g)
