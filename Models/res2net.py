...
def res2net50_v1b_26w_4s(pretrained=False, **kwargs):
    ...
    if pretrained:
        # model_state = torch.load(r"/mnt/datastore1/qinkaiyu/Code_AAAI/pretrain/res2net50_v1b_26w_4s-3cf99910.pth")
        model_state = torch.load(r"C:\Users\yuqinkai\PycharmProjects\Code_AAAI\pretrain\res2net50_v1b_26w_4s-3cf99910.pth")
